...
Tutorial to run Llama-3.1-70b-Instruct NIM on HiPerGator
...
- [Llama-3.1-70b-Instruct Documentation](https://docs.nvidia.com/nim/large-language-models/latest/getting-started.html)
- [Llama-3.1-70b-Instruct on NVIDIA NGC](https://catalog.ngc.nvidia.com/orgs/nim/teams/meta/containers/llama-3.1-70b-instruct)
